...
namespace UI.Controllers
{
    public partial class MovieController
    {
        ...
        protected MovieController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Movie";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Movie";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        {
            public readonly string movieQuery = "movieQuery";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_MovieController : UI.Controllers.MovieController
    {
        public T4MVC_MovieController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string movieQuery, string filter, int? page);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(string movieQuery, string filter, int? page)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "movieQuery", movieQuery);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "filter", filter);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "page", page);
            IndexOverride(callInfo, movieQuery, filter, page);
            return callInfo;
        }
